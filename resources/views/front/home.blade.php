...
<div class="grid sm:grid-cols-2 xl:grid-cols-3 sm:grid-rows-3 md:grid-rows-5 lg:grid-rows-12 xl:grid-rows-1 gap-2 sm:gap-3 md:h-[85vh]">
    <!-- ANA SLAYDER -->
    ...
    <div class="sm:col-span-2 lg:col-span-2 xl:col-span-1
        ...
        <div class="tile flex-col 
            ...
            <div class="contact-details grid grid-cols-2 gap-2 px-[1.6rem] mb-4">
                <div id="mobile_numbers">
                    ...
                    <a class="text-center flex items-center gap-2
                             @if($k==0) btn-3d bg-green-400 text-white font-semibold
