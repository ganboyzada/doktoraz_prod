<div class="md:hidden mobile-menu opened" :class="{ 'opened': open }" x-data="{ open: false }">
    ...
    <div class="mob-menu-frame flex flex-col">
        ...
        <div>
            <div class="grid gap-2 grid-cols-12 grid-row-1 mb-2">
                <a href="tel:{{ str_replace(' ', '', $s_details['mobile'][0]['name']) }}" class="col-span-6 px-1 py-3 btn max-h-[48px] radius-x btn-green justify-center"><i data-feather="smartphone" stroke-width=2></i><span>{{ s_trans('Mobil zəng') }}</span></a>
                <a href="tel:{{ str_replace(' ', '', $s_details['phone'][0]['name']) }}" class="col-span-3 px-1 py-3 btn max-h-[48px] radius-x btn-green justify-center"><i data-feather="phone-call" stroke-width=2></i></a>
                <a href="#" target="_blank" class="col-span-3 px-1 py-3 btn max-h-[48px] radius-x btn-adaptive justify-center" style="background: #128c7e !important;">
