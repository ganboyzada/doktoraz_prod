...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return ObjectController::store($request, $fields, $columns, self::MODEL, null, $this->options);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return ObjectController::update($request, $id, $fields, $columns, self::MODEL, null, $this->options);
    }
